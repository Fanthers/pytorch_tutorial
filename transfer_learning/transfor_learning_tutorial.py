...
def train_and_evaluate_finetuning(model_ft):
...
def train_and_evaluate_feature_extractor(model_conv):
...
if __name__ == '__main__':
    # Visualize_a_few_images()
    # train_and_evaluate_finetuning(model_ft)
    train_and_evaluate_feature_extractor(model_conv)